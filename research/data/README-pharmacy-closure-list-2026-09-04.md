...
## Second wave added (Sept 8, 2026)

`newsweek-rite-aid-further-closures.pdf` (+ extracted text) — Newsweek, Hugh Cameron, "Rite Aid Announces Further Closures: Full List of Locations," July 9, 2025 (https://www.newsweek.com/rite-aid-closures-full-list-locations-2096769; browser save Sept 8, 2026). A later 2025-case wave than the WGRZ list. Its 13 New York addresses were geocoded and appended to the CSV with a `source` column; none duplicates the WGRZ rows. **One is in NY-23: 40 South Erie Street, Mayville (Chautauqua County).** The rest: Buffalo (2), Tonawanda, West Seneca, Cheektowaga (all NY-26), Ransomville (Niagara, NY-24), and downstate. CSV now holds 87 addresses, 20 in NY-23.
