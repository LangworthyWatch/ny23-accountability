---
title: "Telephone Town Halls: Same-Day Notice, Recurring Postponements, Selective Recordings"
date: 2026-05-02
draft: false
topic: "Transparency"
claim_date: "May 2023 – April 2026"
source: "Congressman Nick Langworthy Facebook (verified account)"
source_url: "https://www.facebook.com/CongressmanNickLangworthy"
archived_url: ""
verdict: "DOCUMENTED PATTERN"
tags: ["transparency", "town-halls", "constituent-access", "telephone-town-hall", "documented-pattern"]
counties: ["district-wide"]
---

## Why this matters in NY-23

Rep. Langworthy's office has cited monthly telephone town halls as the principal mechanism for constituent engagement. Because no in-person public town halls have been held since he took office in January 2023 (see the [Constituent Access fact-check](/fact-checks/2025-04-constituent-access-town-halls/)), the tele-town hall is functionally the only standing public Q&A channel available to NY-23 residents. How those events are scheduled, canceled, recorded, and made retrievable is therefore a higher-stakes transparency question than it would be for a member who also held in-person events.

This entry documents 28 tele-town hall posts captured from the Congressman's verified Facebook account between May 2023 and April 2026. The full normalized dataset is published at [/data/town_hall_tracker.csv](/data/town_hall_tracker.csv).
...
| Postponed | 4 |
| Rescheduled after a postponement | 2 |
| **Total** | **28** |
...
| Lead time of public Facebook notice | Count |
|---|---:|
...
| Original date | Stated reason | Rescheduled to |
|---|---|---|
...
| Event date | Recording posted to Facebook |
|---|---|
| 2025-10-28 | 2025-11-01 |
| 2025-11-30 | 2025-11-30 (same day) |
...
| Date | Event |
|---|---|
| 2025-04-07 | Tele-town hall announced for Wednesday 2025-04-09 at 7:30 PM |
| 2025-04-09 | Tele-town hall postponed; cited reason: budget-resolution vote running late |
| **2025-04-11 → 2025-04-18** | Langworthy travels to Greece, sponsored by Republican Main Street Partnership ([Schedule H](/financial-disclosures/#schedule-h--travel-payments-and-reimbursements), entry #9) |
| 2025-04-22 | Reschedule announced for Thursday 2025-04-24 |
| 2025-04-24 | Rescheduled tele-town hall held |
...
- Whether questions were screened in advance — a separate transparency question reported by [WRFA-LP Jamestown](https://www.wrfalp.com/rep-nick-langworthy-repeatedly-fails-to-inform-wrfa-about-news-conferences-being-held-in-chautauqua-county/)
- Any town halls organized by other channels (constituent-side meetings, in-person roundtables described as "town halls," etc.)

The full normalized tracker is at [/data/town_hall_tracker.csv](/data/town_hall_tracker.csv) and will be updated as additional records surface.
...
- [Constituent Access: No In-Person Town Halls in 3+ Years, Office Closures Across District](/fact-checks/2025-04-constituent-access-town-halls/) — establishes that tele-town halls are the *only* public Q&A channel
- [Financial Disclosures & Sponsored Travel](/financial-disclosures/) — Schedule H trip log, used for the April 2025 cross-reference

---

## Sources

* Congressman Nick Langworthy Facebook account (verified): <https://www.facebook.com/CongressmanNickLangworthy> — search results captured 2026-05-02
* Normalized dataset: [/data/town_hall_tracker.csv](/data/town_hall_tracker.csv)
* House Roll Call records (for verifying postponement reasons): <https://clerk.house.gov/Votes>
* House Rules Committee meeting notice schedule: <https://rules.house.gov/announcement>
* WRFA-LP Jamestown (April 2025): ["Rep. Nick Langworthy Repeatedly Fails To Inform WRFA About News Conferences Being Held In Chautauqua County"](https://www.wrfalp.com/rep-nick-langworthy-repeatedly-fails-to-inform-wrfa-about-news-conferences-being-held-in-chautauqua-county/)
* Companion fact-check: [Constituent Access](/fact-checks/2025-04-constituent-access-town-halls/)
