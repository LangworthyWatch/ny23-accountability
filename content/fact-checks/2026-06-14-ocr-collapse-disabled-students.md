...
tags: ["disability", "education", "office-for-civil-rights", "restraint-and-seclusion", "idea", "special-education", "department-of-education", "fact-check"]
...
*The district-level analysis of this data is documented by [The Public Ledgers](https://thepublicledgers.org); the underlying counts are from the Department of Education's public CRDC.*
...
4. **He voted for OBBBA** ([Roll Call 190](https://clerk.house.gov/evs/2025/roll190.xml), July 3, 2025), which cut the Medicaid that reimburses school-based special-education services — a "critical support system" for disabled students.
...
- [Disability: 'Protect Critical Support Systems'](/fact-checks/2026-05-18-aapd-medicaid-disability-contradiction/) — the parent entry; the same pledge against his Medicaid and SSI record
- [Real Cost of OBBBA](/fact-checks/2026-06-02-rural-health-transformation-212m/) — the Medicaid reductions that reach school-based services
...
5. Archive all source URLs; replace source_url with the AAPD + Elmira permalinks; add Wayback links.
6. Confirm committee assignment phrasing (Oversight & Government Reform — member).
7. Update content/fact-checks/_index.md summary table; flip draft:false; deploy.
-->
