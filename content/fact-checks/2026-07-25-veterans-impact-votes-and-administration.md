...
The House voted seven times on measures to end hostilities. **Langworthy voted No every time.**
...
The vehicle that *would* bind — a **joint** resolution — was voted on repeatedly in the Senate in 2026 and **failed every time**. At least ten Iran war-powers joint resolutions were rejected. The most recent discharge attempt failed **47–49 on July 23, 2026**, the same day the House passed H.Con.Res. 89.

**In plain language:** Congress has now said twice, in both chambers once, that this war should end. It said so using the only instrument available to it that the President can lawfully ignore, because the instrument that would bind him cannot get through the Senate. Langworthy voted against all seven attempts.
...
|---|---|---|
| **Sleep apnea** | **50%** when the veteran requires a CPAP machine | **0%** if treatment controls it; 50% only if treatment is ineffective *and* there is no organ damage; 100% only with organ damage |
...
| **Jul. 16** | **Floor** | **Motion to strike Section 108 and the loan fee increase, paying for the bill with unobligated defense funds instead** | **Nay** | **Failed 210–211** |

**That motion failed by one vote.** Because the rule was closed, it was the only remaining route to strip the offsets. The Speaker then pulled the bill; **H.R. 9237 has not passed the House.**

**The veterans organizations are split and we are not flattening it.** DAV, VFW, IAVA, Jewish War Veterans, the Marine Corps League and others opposed the offset. The American Legion, MOAA, Wounded Warrior Project, Vietnam Veterans of America, AMVETS and TAPS backed passage anyway as a net expansion — while conceding in their own letter that writing rating-schedule changes into statute "is not an approach we would support" under ordinary circumstances.
...
| Mar. 2025 | An internal memo from VA's chief of staff sets an objective of returning to 2019 staffing of just under 400,000 — a reduction reported at 80,000 |
...
| Dec. 2025 | VA removes roughly **26,000 unfilled positions** from its rolls |
...
- Removing 26,000 unfilled positions removes the budgeted authority — the position no longer exists to be filled without new approval.
...
Fiscal year to date: **18,305 hires against 24,975 losses.** VHA is down 776 physicians. **VBA is down 1,102 claims examiners.**

Meanwhile, VBA's workload report for **July 18, 2026**: **585,335** claims pending, **67,849** beyond 125 days (11.59%), averaging 64.95 days.

VA's Inspector General found **4,434 severe occupational staffing shortages** across **all 139** medical centers — a 50% increase year over year. That determination is the **FY2025** report issued August 2025; the FY2026 version does not exist yet, and it is frequently misdated. The report also cautions that a severe shortage "is not necessarily an indication of vacancies."
...
|---|---|---|---|
| Research staffing (incl. Toxic Exposures Fund) | 3,706 | — | **3,518** |
| Appropriation-funded research FTE | 3,723 | 3,565 | **3,368** |

That is a **5.1% reduction**, on top of a roughly 3% decline the year before. Testifying to the Senate Veterans' Affairs Committee on **July 22, 2026**, Dr. Glenn D. Graham, president of the Association of VA Neurology Services, noted that with biomedical inflation projected at 2.7%, a 2.4% nominal cut is "approximately a 5 percent loss of real purchasing power."
...
**A clarification that cuts in his favor:** Vietnam Veterans of America **supported passage of H.R. 9237.** It would be false to suggest he met with VVA and then voted against their position on that bill. The groups opposing the offset were DAV, VFW and IAVA. *(VVA's support was distributed as a wire release and quoted by the House Veterans' Affairs Committee; it does not appear on vva.org's own press-release index, so we cite it as such.)*
...
- [On H.R. 9237, His Rules Vote Kept Off the Floor the Amendment That Would Have Dropped the Veterans' Benefit Cuts](/fact-checks/2026-07-03-hr9237-rules-vote-veterans-benefit-cuts/)
- [VA Rural Impact Summary](/fact-checks/2026-02-09-va-rural-impact-summary/)
- [Rules Committee Gatekeeper Pattern](/fact-checks/2026-07-16-rules-committee-gatekeeper-pattern/)
- [Missed Votes](/missed-votes/)
