...
tags: ["housing", "nahb", "campaign-finance", "tariffs", "energy-choice-act", "homebuilders", "fact-check"]
...
The phrase points in a second direction too. NAHB has actively opposed stricter residential energy-efficiency codes — it [sued, with 15 state attorneys general](https://www.nahb.org/news-and-economics/press-releases/2025/01/nahb-15-state-attorneys-general-file-suit-against-huds-energy-codes-mandate), to block adoption of the 2021 energy-efficiency code for federally-backed mortgages, arguing the code raises upfront construction costs. (That mandate was [rescinded effective May 1, 2026](https://www.govinfo.gov/content/pkg/FR-2026-05-01/html/2026-08531.htm).)
...
This is the part of the claim that holds up. Langworthy voted for the 2025 reconciliation law ([Roll Call 190](https://clerk.house.gov/evs/2025/roll190.xml), July 3, 2025), which NAHB praised for "the biggest expansion of the Low-Income Housing Tax Credit in decades." That is a real pro-supply data point and belongs in the record.
...
NAHB itself identifies building-material tariffs as a leading driver of higher home prices, estimating recent tariff actions add about **$10,900 to the price of a typical new home**, and it has specifically opposed [Section 232 tariffs on lumber](https://www.nahb.org/blog/2025/09/section-232-tariffs). Canada is a major source of building materials imported into the United States, including softwood lumber.

On February 11, 2026, the House voted on H.J. Res. 72, which would have terminated the national emergency underpinning the 25% tariffs on Canada. **Langworthy voted Nay** — to keep the tariffs in place ([Roll Call 65](https://clerk.house.gov/evs/2026/roll065.xml); the resolution passed 219–211, with only six Republicans voting yes; Langworthy was not among them).
...
1. NAHB says building-material tariffs add about $10,900 to the price of a new home. How does keeping the Canada tariffs (Roll Call 65) square with "fighting to lower costs"?
2. Does "protect energy choices" refer to anything that lowers a homeowner's energy bills, or to preempting local energy codes?
3. Will Langworthy disclose, alongside the award, that the awarding organization's PAC has contributed $16,500 to his committees?

---

## Related Fact-Checks

- [Langworthy's "Fraud Prevention" Push: What the Bills Do](/fact-checks/2026-06-13-fraud-prevention-package/)
- [The IDA Donor-to-Exemption Pattern](/fact-checks/2026-03-21-ida-donor-exemption-pattern/) — donor-relationship methodology
...
**The award (primary):**
* NAHB: [Defender of Housing Award](https://www.nahb.org/nahb-community/awards/defender-of-housing-award)

**Campaign finance (primary):**
* FEC: [BUILD-PAC (C00000901) committee profile](https://www.fec.gov/data/committee/C00000901/) — five contributions totaling $16,500 to Langworthy committees (2022–2026), confirmed via the FEC API (Schedule B for C00000901); transaction IDs listed above. Circle the Wagons PAC (C00827881) is a leadership PAC whose FEC-listed connected organization is "Langworthy."

**Energy Choice Act (primary):**
* [H.R. 3699 bill text (govinfo)](https://www.govinfo.gov/content/pkg/BILLS-119hr3699ih/xml/BILLS-119hr3699ih.xml) · [status (GovTrack)](https://www.govtrack.us/congress/bills/119/hr3699)
* Langworthy: [Congressman Nick Langworthy Introduces Energy Choice Act](https://langworthy.house.gov/media/press-releases/congressman-nick-langworthy-introduces-energy-choice-act-end-blue-state-wars-0)
* NAHB: [Energy Choice Act Introduced in Congress](https://www.nahb.org/blog/2025/06/energy-choice-act-introduced-in-congress)

**Energy codes (primary):**
* NAHB: [NAHB, 15 State AGs File Suit Against HUD's Energy Codes Mandate](https://www.nahb.org/news-and-economics/press-releases/2025/01/nahb-15-state-attorneys-general-file-suit-against-huds-energy-codes-mandate)
* Federal Register: [Rescission of energy-code mandate, eff. May 1, 2026](https://www.govinfo.gov/content/pkg/FR-2026-05-01/html/2026-08531.htm)

**Tariffs (primary):**
* NAHB: [How Tariffs Impact Home Building](https://www.nahb.org/advocacy/top-priorities/building-materials-trade-policy/how-tariffs-impact-home-building) ($10,900/home estimate)
* NAHB: [Section 232 tariffs on lumber](https://www.nahb.org/blog/2025/09/section-232-tariffs)
* [Roll Call 65](https://clerk.house.gov/evs/2026/roll065.xml) — H.J. Res. 72, Feb. 11, 2026 (Langworthy: Nay)

**Housing votes (primary):**
* [Roll Call 190](https://clerk.house.gov/evs/2025/roll190.xml) — 2025 reconciliation (LIHTC expansion), July 3, 2025 (Langworthy: Aye)
* NAHB: [LIHTC regulatory and legislative actions](https://www.nahb.org/blog/2025/08/lihtc-regulatory-legislative-actions)
...
6. Verify internal cross-links resolve (fraud-package slug; IDA pattern slug).
7. /fact-check-review before commit.
-->
