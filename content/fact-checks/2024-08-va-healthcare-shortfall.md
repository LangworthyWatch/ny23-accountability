---
title: "VA Healthcare: Calling It a 'Staffing Problem' While Supporting Workforce Cuts"
date: 2025-12-22
draft: false
topic: "Veterans"
...
1. **Describes VA problems as a "staffing problem"**
2. **Supports the workforce reduction framework that reduces VA staff**

---

## DOGE Caucus and Workforce Cuts

### Langworthy's Actions

- **Member of the DOGE Caucus** (Delivering Opportunities for Government Efficiency)
...
|--------|--------|-------|--------|
| VA total staff | 484,000 | 454,000 | **-30,000** |
| Method | — | Hiring freezes, deferred resignations, attrition | — |

**February 2025:** The VA Finger Lakes Healthcare System (which includes Bath VA) confirmed **dismissals of probationary staff** as part of DOGE-related reductions.
...
| Metric | Data |
|--------|------|
| Veterans served | 33,000+ across district |
| Coverage area | All seven NY-23 counties |
| Additional clinics | Elmira, Olean |
| Parent system | VA Finger Lakes Healthcare |
...
| Finding | Data |
|---------|------|
| Severe occupational staffing shortages | **4,434** across 139 VHA facilities |
| Change from FY2024 | **+50% increase** |
| Facilities with severe shortages | 139 of 139 (100%) |
| Medical officer shortages | **94%** of facilities |
| Nursing shortages | **79%** of facilities |
| Psychologist shortages | **57%** of facilities |

This data shows staffing shortages **worsened by 50% in one year** while workforce reduction policies were being implemented.
...
| Metric | FY2024 Data |
|--------|-------------|
| New veterans added to disability compensation | **457,919** |
| Increase from prior year | **+25%** |
| PACT Act claims filed nationally | **2.44 million** |
...
Langworthy's characterization of Buffalo's problems as "incompetence, not budget" is **partially supported** by the Inspector General's findings for that specific facility.
...
## Related: Social Security Office Closure

The **Social Security office in Big Flats** (Chemung County) was also listed on the DOGE website for lease non-renewal, affecting another federal service point in the district.

---

## Questions This Raises

1. How can VA problems be a "staffing problem" while supporting policies that reduce VA staff by 30,000?

2. If Bath VA already faces severe shortages (per OIG), how do further staff reductions improve care?

3. With PACT Act claims up 25%, shouldn't VA staffing increase rather than decrease?

4. What is the wait time impact at Bath VA since DOGE-related cuts began?

5. Has Langworthy publicly opposed any specific VA workforce reductions?

---

## Assessment

Langworthy describes VA problems as a **"staffing problem"** while supporting the **workforce reduction framework that reduces VA staff**.

The OIG data shows staffing shortages **worsened by 50%** in one year. Rising PACT Act claims require **more** staff capacity, not less.
...
The tension between the rhetoric and the policy is clear; whether it constitutes a contradiction depends on whether one believes efficiency gains can offset headcount reductions at facilities already in severe shortage.

**Verdict: CONTRADICTION** — Calling it a "staffing problem" while supporting workforce cuts that worsen staffing.
...
* MyTwinTiers: "VA facility in Bath hit by DOGE job cuts" (February 2025)
* WENY News: "Dept. of Veterans Affairs dismisses over 2,000 workers; Bath VA impacted"
* VA News: "VA to reduce staff by nearly 30K by end of FY2025"
