---
title: "SECURE Data Act: Langworthy Cosponsors Federal Bill That Would Preempt the New York Privacy Law the State Senate Just Passed"
date: 2026-06-06
draft: false
topic: "Consumer Protection / Privacy"
claim_date: "April 21, 2026"
source: "Bill Cosponsorship, Committee Hearing"
source_url: "https://www.govinfo.gov/content/pkg/BILLS-119hr8413ih/pdf/BILLS-119hr8413ih.pdf"
archived_url: "https://web.archive.org/web/20260606224604/https://www.uschamber.com/technology/support-for-h-r-8413-secure-data-act"
verdict: "DOCUMENTED PATTERN"
tags: ["legislation", "preemption", "privacy", "data-brokers", "secure-data-act", "hr8413", "states-rights", "shield-act", "ny-privacy-act"]
...
**Bill:** H.R. 8413 — Securing and Establishing Consumer Uniform Rights and Enforcement over Data Act ("SECURE Data Act")
**Introduced:** April 21, 2026
**Sponsor:** Rep. John Joyce (R-PA-13)
**Lead author / driving force:** Although Joyce is the formal sponsor, the bill is widely characterized as the Guthrie-Joyce bill — Energy & Commerce Chair Brett Guthrie (R-KY) is identified as a co-author in the U.S. Chamber's coalition support statement and in multiple industry-side legal analyses.
**Original cosponsors (8):** Mr. Fry (SC), Mr. Kean (NJ), Mr. Obernolte (CA), **Mr. Langworthy (NY-23)**, Mr. Goldman (TX), Mr. Griffith (VA), Mr. Balderson (OH), Mrs. Fedorchak (ND)
**Referred to:** Energy & Commerce Committee; Judiciary Committee
**Hearing:** Subcommittee on Commerce, Manufacturing, and Trade — June 3, 2026
...
> "(A) collects and processes personal data of more than 200,000 consumers annually … and has an annual gross revenue of $25,000,000 or more …; or
> (B) collects and processes personal data of 100,000 or more consumers annually … and derives 25 percent or more of the annual gross revenue of the person from the sale of such personal data."
>
...
One layer is easy to miss: Section 15 does not bind only states. It reads "No State **or political subdivision of a State**" — which reaches counties, cities, and towns. Since this entry was first published, a county in Rep. Langworthy's own region has enacted exactly the kind of local law that language describes. See [Local Law: Erie County](#local-law-erie-county-added-september-1-2026) below.
...
### Local Law: Erie County (added September 1, 2026)

Section 15's reach extends to "political subdivision[s] of a State." Three months after this entry was first published, Erie County enacted a local law squarely of that type.

| Local Law | What It Does | Status | Status Under H.R. 8413 |
|---|---|---|---|
| **Erie County Local Law No. 1-2026** — Biometrics Transparency and Privacy Act | Prohibits commercial establishments from "collecting, storing, procuring, using, and selling or otherwise monetizing a Customer's Biometric Identifier Information in Commercial Settings." Businesses already holding such data must give the county's Director of Consumer Protection written notice within 30 days of the effective date, post conspicuous notice, and file an affidavit certifying destruction. Penalty: **"$1,000.00 to $5,000.00 per day for each day a violation continues."** | Signed May 26, 2026; **in effect June 5, 2026**. Erie County is, per the County Executive's office, "the first county in New York to enact such a ban" | **Within the class Section 15 describes.** The Act defines "biometric data" (Sec. 16(4)) as "data generated by automatic measurements of the biological characteristics of an individual," and treats genetic or biometric data "processed for the purpose of uniquely identifying a specific individual" as sensitive data. Whether a county biometrics ordinance "relates to the provisions of" the federal Act would be litigated, on the same "relates to" standard as the state bills above |

**In plain language:** the preemption question in this entry is usually framed as Washington versus Albany. Section 15's text is not limited to Albany. A biometrics law that Erie County passed and put into force this June sits in the same category as the state bills in the tables above — and Rep. Langworthy is an original cosponsor of the federal bill whose Section 15 describes that category.

**What is not claimed.** H.R. 8413 has not passed; this is preemption on the face of the introduced text, not preemption in force. Whether Erie County's ordinance in fact "relates to the provisions of this Act" is a legal question a court would decide, and this entry does not predict the answer — the same hedge applied to S9088A above. Erie County is only partially inside NY-23, and the ordinance is county-wide. And there is no evidence that Rep. Langworthy knew of the Erie County measure: he cosponsored H.R. 8413 on April 21, 2026; County Executive Mark Poloncarz signed the county law on May 26, 2026 and it took effect June 5. **The point is effect, not intent.**

Compliance with the county law has been thin so far. As of late August 2026, Investigative Post reported that only 30 companies had filed any disclosure and only seven had disclosed actually possessing biometric data — among them Wegmans (which said it disabled the technology at its Amherst Street store in Buffalo and destroyed the data), Rich Products (destroyed), and Delaware North, which told the county it intends to keep scanning faces at Hamburg Gaming and to seek the law's exemption for businesses licensed by the state Gaming Commission.
...
1. **No global opt-out signal requirement.** H.R. 8413 does not require businesses to honor browser-based opt-out preference signals (OOPS). Instead, Sec. 10 directs the Secretary of Commerce to conduct a study on "universal opt-out mechanisms." New York's pending NYPA would require honoring opt-out signals — that requirement would not survive preemption.

2. **No centralized data-broker deletion mechanism.** H.R. 8413 establishes a data-broker registry with minimal disclosure requirements but does not create a one-stop deletion tool. New York's S9088A specifically creates that mechanism — and would be preempted.

3. **Privacy requests are capped at two per year free of charge.** Sec. 2(d)(3)(A) provides that "a consumer may submit to each controller 2 requests … related to such consumer privacy right in a year free of charge." Sec. 2(d)(3)(B) permits a controller to charge a fee — or refuse the request as "manifestly unfounded" — for additional requests. The CCPA does not cap free requests; New York's pending NYPA does not either.

4. **Weaker data minimization.** H.R. 8413 limits data minimization to collection only; the CCPA and the pending NYPA apply it to collection, use, retention, and sharing.

5. **No private right of action.** This is the most consequential difference. Under New York's pending NYPA, an individual New Yorker whose data is misused could sue. Under H.R. 8413, they could not.
...
Fifty-seven business associations signed onto a coalition statement organized by the U.S. Chamber of Commerce supporting H.R. 8413. The list spans every major data-using industry — including the trade associations representing the platforms, ad-tech firms, data brokers, and retail loyalty programs that would be subject to the federal framework. The sector table below groups representative signatories by sector; the complete 57-signatory list (including additional groups like AdvaMed, American Resort Development Association, American Staffing Association, Association of Test Publishers, and the 21st Century Privacy Coalition not shown in the sector summary) is in the U.S. Chamber's "coalition welcome statement" listed in Sources (uschamber.com/technology/business-associations-welcome-federal-data-privacy-legislation). (A separate, longer U.S. Chamber support letter signed by roughly 229 state and local chambers is a different document.)
...
See [Federal Preemption Pattern: Three Bills, One Playbook](/fact-checks/2026-02-state-preemption-pattern/) for the earlier three.
...
> — Rep. Langworthy press release, February 4, 2026

From his February 2026 letter to Commerce Secretary Lutnick on the New York RAISE Act:

> State AI regulations create a "patchwork of conflicting state laws" that "poses risks to U.S. competitiveness."
> — Evans/Langworthy joint letter, February 19, 2026
...
1. **The NY State Senate passed S9088A 51-10 on the same day Rep. Langworthy's federal bill received its first congressional hearing.** Has Rep. Langworthy stated whether he believes New York State should be permitted to enact its own data-broker delete law if the SECURE Data Act becomes federal law?

2. **The bill contains no private right of action.** Has Rep. Langworthy stated a position on whether individual New Yorkers should retain the ability to sue companies that misuse their personal data?

3. **The bill creates a Secretary of Commerce "code of conduct" approval mechanism that produces a rebuttable presumption of compliance.** Under what circumstances should an executive-branch department — rather than a court or independent regulator — be the gatekeeper for whether a privacy law has been complied with?

4. **Rep. Langworthy has not issued a press release on his cosponsorship of H.R. 8413.** What would he tell NY-23 constituents whose privacy protections under the SHIELD Act, the pending NYPA, and S9088A would be partially or wholly preempted?

5. **The endorser coalition includes every major tech, ad-tech, telecom, and data-broker trade association.** No consumer-advocacy organization signed the support letter; the public opposition is from a state privacy regulator (CalPrivacy), a civil-rights coalition (Leadership Conference), and a privacy advocate (EPIC). When industry and consumer advocates split this cleanly on a "consumer protection" bill, which side is reflecting the consumer interest?

---

## Related Fact-Checks

- **[Federal Preemption Pattern: Three Bills, One Playbook](/fact-checks/2026-02-state-preemption-pattern/)** — the earlier three preemption initiatives (Energy Choice, Dietary Supplements, AI letter)
- **[Energy Choice Act: What the Bill Does, Who Supports It, and What It Leaves Out](/fact-checks/2026-02-25-energy-choice-act/)** — the template for industry-coalition + preemption analysis
...
- [H.R. 8413 introduced version — GPO PDF](https://www.govinfo.gov/content/pkg/BILLS-119hr8413ih/pdf/BILLS-119hr8413ih.pdf) — GPO-authenticated; names Langworthy as original cosponsor
- [H.R. 8413 introduced version — GPO XML](https://www.govinfo.gov/content/pkg/BILLS-119hr8413ih/xml/BILLS-119hr8413ih.xml) — machine-readable, bioguide IDs encoded
- [Congress.gov — H.R. 8413](https://www.congress.gov/bill/119th-congress/house-bill/8413)
- [House Energy & Commerce — hearing notice, June 3, 2026](https://energycommerce.house.gov/events/cmt-hearing-examining-legislation-to-establish-a-federal-comprehensive-privacy-and-data-security-law)
- [House Energy & Commerce — post-hearing summary](https://energycommerce.house.gov/posts/cmt-subcommittee-holds-hearing-on-establishing-a-federal-data-privacy-law)

**New York State Legislation (Primary):**
- [NY S9088A — bill text and action history](https://www.nysenate.gov/legislation/bills/2025/S9088) — passed NY Senate 51-10, June 3, 2026
- [NY S3044 — New York Privacy Act, 2025-2026 session](https://www.nysenate.gov/legislation/bills/2025/S3044)
- [NY SHIELD Act — Attorney General resource page](https://ag.ny.gov/resources/organizations/data-breach-reporting/shield-act)
...
- [CalPrivacy press release on opposition letter](https://privacy.ca.gov/2026/04/california-privacy-protection-agency-releases-letter-opposing-the-secure-data-act/)
- [Leadership Conference on Civil and Human Rights — letter opposing](https://civilrights.org/resource/letter-commerce-the-secure-data-act/)
- [Rep. Pallone (E&C Ranking Member) — statement](https://democrats-energycommerce.house.gov/media/press-releases/pallone-republicans-secure-data-act-bill-assembled-industry-friendly-state)

**Industry Coalition (Primary):**
- [U.S. Chamber of Commerce — support letter for H.R. 8413](https://www.uschamber.com/technology/support-for-h-r-8413-secure-data-act)
- [U.S. Chamber of Commerce — coalition welcome statement](https://www.uschamber.com/technology/business-associations-welcome-federal-data-privacy-legislation)
- [BSA — welcome statement](https://www.bsa.org/news-events/news/bsa-welcomes-bill-to-establish-federal-privacy-standards)
- [Digital Advertising Alliance — endorsement](https://digitaladvertisingalliance.org/blog/secure-data-act-landmark-proposed-national-privacy-legislation-recognizes-need-effective-self)

**Erie County Local Law No. 1-2026 (Primary):**
- [Erie County Dept. of Consumer Protection — Biometrics Transparency and Privacy Act, effective 06/05/2026](https://www3.erie.gov/consumerprotection/biometrics-transparency-and-privacy-act) (prohibition, notice requirement, and the "$1,000.00 to $5,000.00 per day" penalty language)
- [Erie County Executive — Poloncarz signs biometrics bill into law, May 26, 2026](https://www4.erie.gov/exec/press/county-executive-poloncarz-signs-biometrics-bill-law) (signing date; "first county in New York to enact such a ban")
- [Investigative Post — "Companies acknowledge using face scans on customers," Aug. 27, 2026](https://investigativepost.org/2026/08/27/companies-acknowledge-using-face-scans-on-customers/) (compliance counts and the Wegmans / Rich Products / Delaware North disclosures)

**Background Analysis:**
- [IAPP — SECURE Data Act analysis](https://iapp.org/news/a/secure-data-act-analysis-of-the-new-federal-privacy-bill)
- [Hunton/Andrews Kurth — privacy law blog analysis](https://www.hunton.com/privacy-and-cybersecurity-law-blog/house-republicans-introduce-comprehensive-federal-privacy-bill-secure-data-act)
- [Epstein Becker Green — analysis](https://www.workforcebulletin.com/one-nation-one-privacy-law-gop-introduces-federal-privacy-legislation)

**Campaign Finance (Primary):**
- FEC bulk data: `indiv22.txt`, `indiv24.txt`, `indiv26.txt`, `pas224.txt`, `pas226.txt` — committees C00817932 (Langworthy for Congress) and C00832188 (Langworthy Congressional Victory Cmte)
...
*Update, September 1, 2026: added the Erie County Local Law No. 1-2026 (Biometrics Transparency and Privacy Act) row and accompanying discussion under "How H.R. 8413 Would Affect New York Specifically." Section 15's preemption text was already quoted verbatim in this entry and is unchanged; the addition documents that its "political subdivision of a State" clause now has a live local instance inside the district's region. The count of Rep. Langworthy's preemption initiatives is unchanged at four — Erie County is a new target of an existing bill, not a new initiative by him.*
