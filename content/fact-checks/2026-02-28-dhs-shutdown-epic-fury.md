---
title: "DHS Shutdown Claim: Langworthy Uses Iran War to Pressure Democrats on Funding"
...
| Component | Workforce Status | Notes |
|-----------|-----------------|-------|
| **ICE & CBP** | Largely unaffected | Tens of billions in separate OBBBA reconciliation funding. CBP paying 57,600+ employees. |
| **TSA** | ~95% of 61,000 working | Screeners faced partial paychecks Feb 28; first full missed paycheck due March 14 |
...
| Democrats "blocking" DHS | **MOSTLY TRUE** procedurally; **MISLEADING** in context |
| Democrats bear sole responsibility | **MISLEADING** — both parties share blame |
| DHS is "the" counterterrorism/cyber agency | **MISLEADING** — one of several; FBI leads terror investigations |
| Grave risk during this moment | **PARTIALLY TRUE** — real risks exist, but critical ops continued |
