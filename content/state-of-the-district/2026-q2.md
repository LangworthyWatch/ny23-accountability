...
1. Decide site nav: add State of the District to hugo.toml menu.
2. Archive all primary sources (incl. nysfocus.com original via Wayback web UI); add archived-copies block.
3. Final /fact-check-review pass; flip draft: false; announce on homepage.
-->
