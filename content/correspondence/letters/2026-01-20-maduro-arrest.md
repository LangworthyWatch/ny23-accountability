---
title: "Venezuela/Maduro Arrest - Constituent Response"
date: 2026-01-20
draft: false
...
days_waiting: 0
tracking_code: "[Multiple variations documented]"
---

## Contact Information

**Date:** January 20-25, 2026
**Method:** Email via Langworthy.house.gov
**Topic:** Venezuela military operation / Maduro arrest
**Response Status:** Form letter (at least 4 variations documented)
...
| Variation | Sent To | Key Difference |
|-----------|---------|----------------|
| **Standard** | Supporters | Full praise for operation |
| **Concerns** | Those with concerns | Acknowledges concerns, defends anyway |
| **War Powers** | Those citing Congress | Defers to Article II authority |
| **Military** | Those worried about troops | Cites constitutional authority |
...
| Figure | Crime | Outcome | Langworthy Position |
|--------|-------|---------|---------------------|
| **Maduro** | Indicted: drug trafficking | Arrested | "Major milestone" |
| **Hernandez** | Convicted: 400 tons cocaine | Pardoned | "Constitutional authority" + pivot to Biden |
...
- [Correspondence: Hernandez Pardon](/correspondence/letters/2026-01-21-hernandez-pardon/)
