...
- **Still open on this thread:** the **10,000 figure is ICE data as of Apr 2, 2026 and is ~3.5 months stale** — refresh before publish and check for a post-Jun-15 figure now that Partial Claim has launched (added as `hold_reason` item 5). No NY-23 or NY district-level foreclosure figure is published; don't invent one.
