...
- **RHTP $76.2M, fourth announcement (official page, Sept 11, ICYMI of a Finger Lakes Daily News item): "proud to have helped deliver $76.2 million... Now they'll have the resources."** Same state-allocation figure as the Sept 4 addendum on the RHTP entry; FLDN article URL not located (site search JS-walled); WBNG Sept 10 and Fingerlakes1 Sept 4 coverage exist. **Update the RHTP entry's count and the North Aud table's "announced three times" to four when next touched.** RCHI award list still not published by NY DOH (watch item stands).
