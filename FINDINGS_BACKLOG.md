...
- **Date logged:** 2026-07-03 · **Type:** story-lead · **Status:** in-progress · **Priority:** high
- **Detail:** The committee-record fact-check (2026-07-03-committee-record-medicaid-seat-at-the-table) opened four follow-on threads, all resting on his Rules + E&C seats. (1) **Tariffs × Rules** — the majority used special rules to deem days "not a legislative day" and neutralize privileged tariff/emergency-termination resolutions (National Emergencies Act clock), blocking floor votes to end tariffs his district's manufacturers blamed for closures (Bush Industries/eSolutions, Jamestown Advanced); pull his by-name Rules Committee votes on those rules (CRPT-119hrpt* "Committee Votes"). Research agent run this session. (2) **Energy × E&C** — clean-energy credit repeal in OBBBA's E&C energy subtitle affecting 271+ rural NY-23 projects (REAP); his Energy Choice Act (H.R.3699) + State Energy Accountability Act (H.R.3157). Research agent run this session. (3) **FY2026 Labor-HHS appropriations rules** — not yet surveyed for more closed-rule health votes; check each approps special rule at rules.house.gov/legislation. (4) **Did Langworthy speak at the May 13 E&C markup** — needs the committee video/transcript (energycommerce.house.gov markup archive / YouTube); would upgrade the E&C section from "voted" to "voted and said X."
