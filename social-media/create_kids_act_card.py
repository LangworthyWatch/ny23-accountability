#!/usr/bin/env python3
"""Social card: KIDS Act 'holds Big Tech accountable', MISSING CONTEXT, June 30, 2026.
Bipartisan passage is real; the core accountability rule was cut and privacy groups object."""
...
f_label=font("Arial Bold.ttf",20); f_label_s=font("Arial Bold.ttf",16); f_big=font("Impact.ttf",70)
...
draw.text((WIDTH//2,y),"'Holds Big Tech Accountable'? What Got Cut",fill=NAVY,font=f_topic,anchor="mm"); y+=44
...
draw.text((76,y+50),'"[The KIDS Act] strengthens privacy protections',fill=DARK,font=f_sub,anchor="lm")
draw.text((76,y+76),'and holds Big Tech accountable."',fill=DARK,font=f_sub,anchor="lm")
...
draw.text((lx+col_w//2,y+22),"WHAT'S TRUE",fill=GREEN,font=f_label_s,anchor="mm")
draw.text((lx+col_w//2,y+92),"267-117",fill=GREEN,font=f_big,anchor="mm")
draw.text((lx+col_w//2,y+158),"bipartisan House passage",fill=DARK,font=f_sub_b,anchor="mm")
draw.text((lx+col_w//2,y+188),"a KOSA + COPPA 2.0 package;",fill=DARK,font=f_sub,anchor="mm")
draw.text((lx+col_w//2,y+216),"he voted Yea (Roll Call 228)",fill=DARK,font=f_sub,anchor="mm")
draw.rounded_rectangle([(rx,y),(rx+col_w,y+col_h)],radius=8,fill="#FFF5F5",outline="#FEB2B2",width=2)
draw.text((rx+col_w//2,y+22),"WHAT'S OMITTED",fill=RED,font=f_label_s,anchor="mm")
draw.text((rx+col_w//2,y+92),"NARROWED",fill=RED,font=font("Impact.ttf",58),anchor="mm")
draw.text((rx+col_w//2,y+158),"the 'duty of care'",fill=DARK,font=f_sub_b,anchor="mm")
draw.text((rx+col_w//2,y+188),"KOSA's core accountability rule",fill=DARK,font=font("Arial.ttf",16),anchor="mm")
draw.text((rx+col_w//2,y+216),"was cut back in the House bill",fill=DARK,font=font("Arial.ttf",16),anchor="mm")
y+=col_h+18

strip_h=150
draw.rounded_rectangle([(44,y),(WIDTH-44,y+strip_h)],radius=8,fill="#EDF2F7",outline=BORDER,width=2)
draw.text((WIDTH//2,y+20),"WHAT THE PRIVACY GROUPS SAY",fill=NAVY,font=f_label,anchor="mm")
third=(WIDTH-88)//3
for i,(val,l1,l2,c) in enumerate([
    ("All users","age verification","not just kids (EFF)",RED),
    ("Encrypted","new messaging rules","+ directed moderation",NAVY),
    ("EFF + ACLU","oppose the bill","free speech + privacy",GREEN),
]):
...
draw.text((WIDTH//2,y+30),"It did pass with bipartisan support. But its core accountability rule was cut, the leading",
          fill=LIGHTGRAY,font=font("Arial.ttf",16),anchor="mm")
draw.text((WIDTH//2,y+62),"privacy groups say it erodes privacy, and he cosponsors a bill preempting stronger state law.",
          fill=WHITE,font=font("Arial Bold.ttf",17),anchor="mm")
y+=kick_h+16
draw.text((WIDTH//2,y),"Sources: House Clerk (Roll Call 228)  ·  EFF  ·  ACLU  ·  Roll Call  ·  congress.gov",
...
out="/Users/zachbeaudoin/projects/Langworthywatch/langworthy-tracker/social-media/kids_act_card.png"
