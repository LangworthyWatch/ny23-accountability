...
c.text(170, y + 46, "37%", size=50, impact=True, fill=RED, anchor="mm")
c.text(170, y + 88, "of the rural Medicaid cut", size=13, bold=True, fill=MUTED, anchor="mm")
c.text(170, y + 106, "is covered by the fund (KFF)", size=13, bold=True, fill=MUTED, anchor="mm")
